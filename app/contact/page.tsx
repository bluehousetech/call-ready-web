...
export default function ContactPage() {
  const [formData, setFormData] = useState({
    name: "",
    email: "",
    phone: "", // E.164 for Twilio, e.g. +15551234567
    phone_display: "", // National display, e.g. (555) 123-4567
    org_name: "",
    message: "",
  });
  ...
  const handleChange = (
    ...
    if (e.target.name === "phone_display") {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (!formData.phone) {
        setSubmitMessage("Please enter a valid US phone number.");
        return;
      }
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600">
              Ready to never miss another call? We&apos;re here to help you get
              started.
            </p>
          </div>
        </div>
      ...
      <section className="section-padding">
        <div className="container-custom">
          <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
            {/* Contact Form */}
            <div>
              <h2 className="heading-sm text-dark-500 mb-6">
                Send Us a Message
              </h2>
                  ...
                  <div className="card">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <h3 className="text-lg font-semibold text-dark-500 mb-1">
                          Message sent
                        </h3>
                        <p className="text-gray-600 mb-4">
                          Thanks — we got it. While you wait, you can experience
                          Call Ready in under a minute.
                        </p>
                        <Link
                          href="/try-it-now"
              ...
              <div className="space-y-6">
                ...
                <div className="card">
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <a
                        href="tel:+1234567890"
                        className="text-primary-500 hover:text-primary-600 text-lg"
                      >
                        (XXX) XXX-XXXX
                      </a>
                ...
                <div className="card">
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <a
                        href="mailto:support@callready.com"
                ...
                <div className="bg-gradient-to-br from-primary-500 to-teal-500 rounded-xl p-6 text-white">
                  ...
                  <p className="mb-4 opacity-90">
                    For existing customers with urgent technical issues, call
                    our emergency line:
                  </p>
                  <a
                    href="tel:+1234567890"
                  ...
                  <p className="text-sm mt-2 opacity-75">
                    24/7 for Business plan customers
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="card">
                ...
                <p className="text-gray-600">
                  Most customers are up and running within 10 minutes. Our
                  onboarding process is simple and guided. If you need help, our
                  team can walk you through setup via phone or video call.
                </p>
              </div>
              <div className="card">
                <h3 className="text-lg font-semibold text-dark-500 mb-2">
                ...
                <p className="text-gray-600">
                  No! Call Ready works with your existing business phone number.
                  We integrate seamlessly without requiring any changes to your
                  current setup.
                </p>
              </div>
              <div className="card">
                ...
                <p className="text-gray-600">
                  Our support team is available via phone, email, and live chat
                  during business hours. Business plan customers get 24/7
              ...
              <div className="card">
                ...
                <p className="text-gray-600">
                  Absolutely! We offer personalized demos where we&apos;ll show
                  you exactly how Call Ready works for your specific business.
                  Use the contact form above to request a demo, or call us
                  directly.
                </p>
              </div>
            </div>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Call our live demo line right now and experience Call Ready
              firsthand. Completely anonymous, no strings attached.
            </p>
